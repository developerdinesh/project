...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'effect' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'effect' ),
		'repeat-y'  => __( 'Repeat Vertically', 'effect' ),
		'repeat'    => __( 'Repeat All', 'effect' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'effect' ),
		'top center'    => __( 'Top Center', 'effect' ),
		'top right'     => __( 'Top Right', 'effect' ),
		'center left'   => __( 'Middle Left', 'effect' ),
		'center center' => __( 'Middle Center', 'effect' ),
		'center right'  => __( 'Middle Right', 'effect' ),
		'bottom left'   => __( 'Bottom Left', 'effect' ),
		'bottom center' => __( 'Bottom Center', 'effect' ),
		'bottom right'  => __( 'Bottom Right', 'effect')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'effect' ),
		'fixed'  => __( 'Fixed in Place', 'effect')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'effect' ),
		'italic'      => __( 'Italic', 'effect' ),
		'bold'        => __( 'Bold', 'effect' ),
		'bold italic' => __( 'Bold Italic', 'effect' )
		);
