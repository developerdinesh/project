...
function level_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => 'Sidebar widget for all pages included Post, Pages',
	...
	register_sidebar( array(
		...
		'id'            => 'post-widget-1',
		'description'   => 'This will aside post content and show widgets ',
...
register_sidebar( array(
		...
		'id'            => 'below-navi',
		'description'   => 'This widget show just above content and below main navigation',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
register_sidebar( array(
		...
		'id'            => 'content-end',
		'description'   => 'After post content and above comment',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
register_sidebar( array(
		...
		'id'            => 'footer-1',
		'description'   => 'Footer widget area first from left',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
register_sidebar( array(
		...
		'id'            => 'footer-2',
		'description'   => 'Footer widget area Second from left',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
register_sidebar( array(
		...
		'id'            => 'footer-3',
		'description'   => 'Footer widget area Third from left',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
register_sidebar( array(
		...
		'id'            => 'footer-4',
		'description'   => 'Footer widget area fourth from left',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
